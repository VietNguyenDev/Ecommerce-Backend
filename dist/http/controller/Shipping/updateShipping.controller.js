...
function updateShipping(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const data = yield shipping_service_1.default.updateShipping(parserId, { userId, fullName, address, province, district, ward, postcode, phone });
...
//# sourceMappingURL=updateShipping.controller.js.map